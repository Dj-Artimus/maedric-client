...
const Header = () => {
  ...
  return (
    <header className={`w-full sticky top-0 z-50 transition-all duration-300`}>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-primary/60 z-50 flex flex-col p-16 backdrop-blur-3xl drop-shadow-2xl drop-shadow-[#30303066]">
          {/* Close Icon */}
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="hover:text-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-accent transition-colors duration-200 p-1 rounded"
